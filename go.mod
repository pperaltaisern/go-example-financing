...
require (
	github.com/pperaltaisern/app v1.0.0
	github.com/pperaltaisern/esrc v1.0.1
	github.com/pperaltaisern/esrcpg v1.0.0
	github.com/pperaltaisern/esrcwatermill v1.0.0
